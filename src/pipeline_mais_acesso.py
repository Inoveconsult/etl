...
def carregar_tratar_dados_mais_acesso(
    caminho_arquivo,
    faixas,
    coluna_origem_excel,
    coluna_pontuacao,
    ...
    colunas_remover = [
        ...
        "SIGLA DA EQUIPE",
        "NUMERO TOTAL DE ATENDIMENTOS POR DEMANDA PROGRAMADA",
        "NUMERO TOTAL DE ATENDIMENTOS POR TODOS OS TIPOS DE DEMANDAS (ESPONTANEAS E PROGRAMADAS)"
    ]
